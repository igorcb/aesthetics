...
class BrandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brand" do
    assert_difference("Brand.count") do
      post brands_url, params: { brand: { name: @brand.name, observation: @brand.observation } }
    end
  ...
  test "should update brand" do
    patch brand_url(@brand), params: { brand: { name: @brand.name, observation: @brand.observation } }
